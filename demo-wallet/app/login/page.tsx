...
function LoginPageContent() {
  ...
  const successMessage = useMemo(() => {
    if (searchParams.get("registered") === "1") {
      return "Wallet created successfully. Please sign in to continue.";
    }
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("/api/demo-wallet/login/start", {
        method: "POST",
        ...
        >
          ...
          >
            ...
            <span>
              ...
              security challenge to access your wallet.
            </span>
          </div>
        </form>
      </div>
