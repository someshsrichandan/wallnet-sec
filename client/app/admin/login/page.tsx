...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative selection:bg-indigo-100 selection:text-indigo-900">
      <div className="absolute inset-x-0 top-0 h-[30rem] bg-[radial-gradient(circle_at_50%_0%,rgba(120,119,198,0.1),transparent_50%)] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          Sign in to manage visual verification metrics
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <Card className="shadow-lg border-slate-200">
          ...
          <CardFooter className="flex justify-center border-t border-slate-100 bg-slate-50/50 p-4">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/admin/signup" className="font-semibold text-slate-900 hover:text-indigo-600 transition-colors">
                Apply for access
              </Link>
            </p>
          </CardFooter>
        ...
        <div className="mt-8 flex items-center justify-center gap-6 text-sm text-slate-500">
           <span className="flex items-center gap-1"><Shield className="h-4 w-4" /> SMS Verified</span>
           <span className="flex items-center gap-1"><Lock className="h-4 w-4" /> 256-bit Encrypted</span>
        </div>
      </div>
    </div>
  );
