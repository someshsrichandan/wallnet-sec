          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 shadow-sm dark:border-amber-900/30 dark:bg-amber-900/10">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <div>
                     <h3 className="font-bold text-amber-900 dark:text-amber-200">New API Key Generated</h3>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-amber-200 hover:bg-amber-100 dark:border-amber-800 dark:hover:bg-amber-900/30"
                  ...
                  <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="rounded-md bg-slate-50 px-3 py-2 font-mono text-xs text-slate-600 dark:bg-slate-950 dark:text-slate-400">
                        {k.apiKeyPreview ? `${k.apiKeyPreview}••••••••••` : k.apiKey}
                      </div>
